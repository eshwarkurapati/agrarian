...
function grow_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'grow-thinkup-style-magazine', get_stylesheet_directory_uri() . '/style.css', array( 'thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function grow_thinkup_updateoption_child_settings() {
	...
	$name_options_child   = $name_theme_lower . '_thinkup_child_settings_magazine';
